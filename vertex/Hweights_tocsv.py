...
group.add_argument(
    '--output', help='where you are going to output', required=True)
...
df_sorted_nmfweights = append_subjweights_plsstyle(df_sorted, h_z, args.metrics)
...
df_sorted_nmfweights.to_csv(args.output+fname_alldata, index = False) 
...
df_nmfweights_pls.to_csv(args.output+fname_pls_data, index = False) 
