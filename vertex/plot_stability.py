...
group.add_argument('--spacing', help='interval between computed ks', type=int, default=2)

group.add_argument(
    "--stability_correlations",help="csv containing all computed stability metrics", required=True)
...
plt.savefig(args.output+"/plot_stability.png", dpi='figure', bbox_inches='tight')
